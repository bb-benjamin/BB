...
const ContactUs = () => {
  ...
  return (
    <div className=" font-SpaceGrotest mx-5 flex flex-col gap-3 text-center md:mx-28 lg:gap-20 lg:mx-5 lg:text-start lg:flex-row lg:justify-between text-centers items-center">
      ...
      <form
        onSubmit={validate}
        className="contact_form font-medium  text-white whitespace-nowrap mt-5 w-full"
      >
        <div className="">
          <label
            htmlFor="name"
            className="peer-focus:font-medium text-sm text-gray-500  peer-focus:text-[#4EE1A0]  "
          ></label>
          <input
            type="text"
            name="name"
        ...
        <div className="">
          <label
            htmlFor="email"
            className="peer-focus:font-mediumtext-sm text-gray-500  "
          ></label>
          <input
            type="email"
            name="email"
        ...
        <div className=" text-end ">
          <button
            type="submit"
            className="mt-5 border-b-2 border-[#4EE1A0] tracking-[1px] active:text-[#4EE1A0] leading-10 cursor-pointer"
          >
            SEND MESSAGE
          </button>
        </div>
