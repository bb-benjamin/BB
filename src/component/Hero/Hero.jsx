...
import benjamin from "../../assets/benji.png";
      ...
      <section className="container px-5 z-50">
        <div className="div ">
          <div className="top__text font-bold text-[40px] mt-10 md:mt-15 lg:mt-36 xl:mt-36 md:text-[72px] lg:text-[88px] md:leading-[88px]">
            ...
            <div>
              <h1 className="md hidden md:contents lg:hidden ">
                {" "}
                meet you! I'm
              </h1>
            </div>
            <div>
              <p className="hidden md:contents lg:hidden">
                <span className="heroName_span border-b-2 border-[#4EE1A0] tracking-[1.9px]">
                  Benjamin Botchway
                </span>
              </p>
            </div>
            <p className=" md:hidden lg:contents">
              {" "}
              Nice to meet you! <br />
            </p>
            <p className=" md:hidden lg:contents">
      ...
      <section>
        <picture className=" w-full   ">
          <img
            src={benjamin}
            alt="benjamin"
            className="bg-[#242424] w-[232px] h-[383px]md:w-[322px] md:h-[600px] md:absolute md:right-px md:top-0 lg:w-[445px] lg:h-[702px] lg:absolute lg:top-0 lg:inset-[54.6%] xl:inset-[62.9%] xl:top-0 z-0"
          />
        </picture>
      </section>
    </div>
