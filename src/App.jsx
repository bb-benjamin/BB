        ...
        <div className="container mx-auto">
          ...
          <div className="top__shape ">
            <img
              src={circles}
              alt="left-shape"
              className="absolute left-[-200px] top-[139px] md:top-[85px] lg:top-[139px]"
            />
          </div>
          ...
          <div className="middle__shape">
            <img
              src={HalfOval}
              alt="left-shape"
              className=" lg:hidden absolute right-px z-50 top-[354px] md:top-[471px]"
            />
          </div>
          ...
          <div className="middle__shape hidden lg:contents">
            <img
              src={oval}
              alt="left-shape"
              className="absolute  right-px z-50 top-[354px] lg:top-[521px] lg:left-[48.5%] xl:left-[58.5%]"
            />
          </div>
          <Hero />
          ...
          <div className="middle__shape ">
            <img
              src={leftcirclesMobile}
              alt="left-shape"
              className="absolute right-0 top-[1287px] md:top-[894px] lg:hidden"
            />
          </div>
          ...
          <div className="middle__shape hidden lg:contents">
            <img
              src={leftcircles}
              alt="left-shape"
              className="absolute  right-0 z-50 top-[977px] xl:right-0"
            />
          </div>
        ...
        <section className=" container mx-auto bg-[#242424] z-0">
          ...
          <div className="top__shape ">
            <img
              src={circles}
              alt="left-shape"
              className="absolute left-[-200px] top-[1882px] md:top-[2695px] lg:top-[3000px] xl:top-[1457px]"
            />
          </div>
